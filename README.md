...
|---------|-------------|------|
| 🍔 **ZOMATO-SAAS** | Production-level food ordering SaaS | MERN |
| 💬 **chitzy** | Realtime chat application | MERN + Socket |
| 🔐 **Mern-Auth** | Secure authentication system | JWT + MERN |
| 🌐 **ASHU-3D-PORTFOLIO** | Modern 3D animated portfolio | React + ThreeJS |
| 🤖 **Student Predictor** | ML prediction system | Python + ML |
| 🧠 **AI Calculator** | AI-powered smart calculator | JS + AI |
...
<p align="center">
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Ashu8477&layout=compact&theme=tokyonight"/>
</p>
